...
_G.packer_plugins = {
  ...
  ["codeium.vim"] = {
    loaded = true,
    path = "/home/v/.local/share/nvim/site/pack/packer/start/codeium.vim",
  ...
  playground = {
    loaded = true,
    path = "/home/v/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["prettier.nvim"] = {
    loaded = true,
    path = "/home/v/.local/share/nvim/site/pack/packer/start/prettier.nvim",
